...
%            \draw[dashed] (1,4)--(orig2);
    ...
    Podemos observar por la descomposición en las componentes cartesianas de cada vector de campo eléctrico que el
    campo en la dirección $\mathbf{u}_y$ siempre es igual al campo en la dirección $\mathbf{u}_z$.
